...
import { loadSystemPromptConfigFromEnv, validateSystemPromptConfig, mergeSystemPromptConfig, } from './system-prompt-config.js';
 ...
 */
export function createFullyIntegratedGanAuditor(config) {
    ...
    try {
        ...
        componentLogger.error('Failed to create fully integrated GAN auditor', error);
        throw error;
    }
}
/**
 ...
 */
export async function createSystemPromptFromTemplate(templatePath, variables) {
 ...
 */
export function validateSystemPromptSetup(config) {
    const errors = [];
    const warnings = [];
 ...
 */
export function createDevelopmentSystemPromptConfig() {
 ...
 */
export function createProductionSystemPromptConfig() {
    return mergeSystemPromptConfig({
        identity: {
            name: 'Kilo Code',
 ...
 */
export async function validateSystemPromptTemplate(templatePath) {
    const errors = [];
    const warnings = [];
 ...
 */
export function logSystemPromptSetup(config, validation) {
