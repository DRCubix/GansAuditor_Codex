 ...
 */
export async function executeDynamicStep(inputs, outputs, evidence) {
    try {
 ...
 * Test edge cases and boundary conditions
 */
async function testEdgeCases(inputs) {
    const results = [];
    try {
 ...
 */
async function simulateEdgeCaseTest(edgeCase, inputs) {
 ...
 * Validate error handling paths
 */
async function validateErrorHandling(inputs) {
    const results = [];
    try {
 ...
 */
async function simulateErrorHandlingTest(scenario, inputs) {
 ...
 * Check performance characteristics
 */
async function checkPerformance(inputs) {
    try {
 ...
 * Scan for security vulnerabilities
 */
async function scanSecurityVulnerabilities(inputs) {
    const findings = [];
    try {
 ...
 */
async function analyzeFileForSecurityIssues(file, workspacePath) {
    const findings = [];
    try {
 ...
 */
async function performGeneralSecurityChecks(inputs) {
    const findings = [];
    try {
 ...
 * Add evidence based on dynamic analysis results
 */
async function addDynamicAnalysisEvidence(outputs, evidence) {
 ...
 */
export const DEFAULT_DYNAMIC_INPUTS = {
    workspacePath: process.cwd(),
    runtime: 'node'
};
//# sourceMappingURL=dynamic-step.js.map