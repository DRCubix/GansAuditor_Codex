 ...
 */
import { DEFAULT_AUDIT_WORKFLOW, DEFAULT_WORKFLOW_CONFIG } from './workflow-types.js';
// ============================================================================
...
export class AuditWorkflowEngine {
     ...
     */
    async executeNextStep(stepInputs) {
     ...
     */
    async executeInitStep(outputs, evidence, inputs) {
     ...
     */
    async executeReproStep(outputs, evidence, inputs) {
     ...
     */
    async executeStaticStep(outputs, evidence, inputs) {
     ...
     */
    async executeTestsStep(outputs, evidence, inputs) {
     ...
     */
    async executeDynamicStep(outputs, evidence, inputs) {
     ...
     */
    async executeConformStep(outputs, evidence, inputs) {
     ...
     */
    async executeTraceStep(outputs, evidence, inputs) {
     ...
     */
    async executeVerdictStep(outputs, evidence, inputs) {
     ...
     */
    generateNextActions(step, evidence) {
        const actions = [];
     ...
     */
    getEvidenceBySeverity(severity) {
 ...
 */
export function createAuditWorkflowEngine(workflow, config) {
