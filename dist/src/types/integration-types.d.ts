 ...
 */
import type { GansAuditorCodexThoughtData, GansAuditorCodexReview, GansAuditorCodexSessionConfig, GansAuditorCodexSessionState, GansAuditorCodexAuditRequest, GansAuditorCodexToolResponse, GansAuditorCodexStandardResponse, GansAuditorCodexEnhancedResponse, IterationData, ProgressAnalysis, StagnationResult, TerminationReason } from './gan-types.js';
/**
...
export interface IGansAuditorCodexSessionManager {
     ...
     */
    addWorkflowStepResult(sessionId: string, stepName: string, stepResult: {
        success: boolean;
        evidence: string[];
        issues: Array<{
    ...
    }, thoughtNumber: number): Promise<void>;
    /**
     * Track quality progression across iterations
     */
    trackQualityProgression(sessionId: string, qualityMetrics: {
        timestamp: number;
     ...
     */
    storePromptContext(sessionId: string, promptContext: {
...
export interface IGansAuditorCodexJudge {
     ...
     */
    executeAuditWithSystemPrompt(request: GansAuditorCodexAuditRequest, systemPrompt: string, promptContext?: {
        variables: Record<string, any>;
        metadata: any;
     ...
     */
    generateStructuredAuditPrompt(request: GansAuditorCodexAuditRequest, systemPrompt: string, promptContext?: {
        variables: Record<string, any>;
        metadata: any;
    }): string;
}
...
export type AuditEvent = {
    ...
    sessionId: string;
    verdict: GansAuditorCodexReview['verdict'];
} | {
    type: 'audit_failed';
    sessionId: string;
    error: string;
 ...
 */
export declare const DEFAULT_GANSAUDITOR_CODEX_CONFIG: GansAuditorCodexConfig;
/**
