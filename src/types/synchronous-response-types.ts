...
// ============================================================================
// Completion and Loop Information Types
// ============================================================================
 ...
 */
export enum FeedbackDetailLevel {
  MINIMAL = "minimal",
  STANDARD = "standard",
  DETAILED = "detailed",
 ...
 */
export const DEFAULT_ENHANCED_RESPONSE_CONFIG: EnhancedResponseConfig = {
 ...
 */
export function isSynchronousEnhancedResponse(obj: any): obj is SynchronousEnhancedResponse {
  return (
    obj &&
    typeof obj === 'object' &&
 ...
 */
export function isStructuredFeedback(obj: any): obj is StructuredFeedback {
  return (
    obj &&
    typeof obj === 'object' &&
 ...
 */
export function isCompletionStatus(obj: any): obj is CompletionStatus {
  return (
    obj &&
    typeof obj === 'object' &&
 ...
 */
export function isLoopInfo(obj: any): obj is LoopInfo {
  return (
    obj &&
    typeof obj === 'object' &&
    typeof obj.currentLoop === 'number' &&
