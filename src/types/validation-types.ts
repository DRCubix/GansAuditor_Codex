...
export type ConfigMerger = (
  base: GansAuditorCodexSessionConfig,
  override: Partial<GansAuditorCodexInlineConfig>
) => GansAuditorCodexSessionConfig;
 ...
 */
export type ScopedConfig<S extends SessionConfig['scope']> = S extends 'paths'
  ? RequireFields<SessionConfig, 'paths'>
  : SessionConfig;