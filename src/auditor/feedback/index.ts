...
export {
  ...
  createStructuredFeedbackSystem,
  validateStructuredFeedbackOutput,
  DEFAULT_STRUCTURED_FEEDBACK_CONFIG
} from './structured-feedback-system.js';

export type {
  StructuredFeedbackConfig,
...
export {
  ...
  createExecutiveVerdictGenerator,
  validateExecutiveVerdict,
  DEFAULT_EXECUTIVE_VERDICT_CONFIG
} from './executive-verdict-generator.js';

export type {
  ExecutiveVerdictConfig,
  VerdictGenerationContext
} from './executive-verdict-generator.js';

// Evidence table generation (5.2)
export {
  EvidenceTableGenerator,
  createEvidenceTableGenerator,
  validateEvidenceTable,
  DEFAULT_EVIDENCE_TABLE_CONFIG
} from './evidence-table-generator.js';

export type {
  EvidenceTableConfig,
  EvidenceTableGenerationContext,
  LocationFormattingConfig,
  ProofHandlingConfig
} from './evidence-table-generator.js';
...
export {
  ...
  createProposedDiffGenerator,
  validateProposedDiff,
  DEFAULT_PROPOSED_DIFF_CONFIG
} from './proposed-diff-generator.js';
...
export {
  ...
  createReproductionGuideGenerator,
  validateReproductionGuide,
  DEFAULT_REPRODUCTION_GUIDE_CONFIG
} from './reproduction-guide-generator.js';

export type {
  ReproductionGuideConfig,
  ReproductionGuideContext,
...
export {
  ...
  createFollowUpTaskGenerator,
  validateFollowUpTaskList,
  DEFAULT_FOLLOW_UP_TASK_CONFIG
} from './follow-up-task-generator.js';
