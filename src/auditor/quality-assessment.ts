...
// ============================================================================
// Quality Dimension Types and Interfaces
// ============================================================================
...
export type EvaluationMethod = 
  | "automated_check"    // Automated tools (linting, testing, etc.)
  | "manual_review"      // Manual code review
  | "metric_analysis"    // Quantitative metrics
  | "pattern_matching"   // Code pattern detection
  | "coverage_analysis"  // Test/requirement coverage
...
export class QualityAssessmentFramework {
  ...
  private config: QualityFrameworkConfig;
  ...
  async evaluateQuality(
    ...
    const passesShipCriteria = this.evaluateShipCriteria(
      overallScore,
   ...
   */
  private calculateWeightedScore(evaluations: DimensionEvaluation[]): number {
    let weightedSum = 0;
    let totalWeight = 0;
   ...
   */
  private calculateCriterionWeightedScore(evaluations: CriterionEvaluation[]): number {
    let weightedSum = 0;
    let totalWeight = 0;
   ...
   */
  private validateDimension(dimension: QualityDimension): void {
   ...
   */
  private extractCriticalIssues(evaluation: DimensionEvaluation): CriticalIssue[] {
   ...
   */
  private generateDimensionImprovements(criterionEvaluations: CriterionEvaluation[]): string[] {
 ...
 */
export const DEFAULT_QUALITY_FRAMEWORK_CONFIG: QualityFrameworkConfig = {
 ...
 */
export function createDefaultQualityFramework(
  config?: Partial<QualityFrameworkConfig>
 ...
 */
export function validateQualityDimensions(dimensions: QualityDimension[]): string[] {
  const errors: string[] = [];
 ...
 */
export function validateQualityDimension(dimension: QualityDimension): string[] {
  const errors: string[] = [];
 ...
 */
export function getQualityDimensionById(
 ...
 */
export function getQualityCriterionById(
  dimension: QualityDimension,
  id: string
): QualityCriterion | undefined {
 ...
 */
export function getFailingDimensions(
  assessment: QualityAssessment
): DimensionEvaluation[] {
 ...
 */
export function getCriticalIssuesByDimension(
  assessment: QualityAssessment
): Record<string, CriticalIssue[]> {
  const issuesByDimension: Record<string, CriticalIssue[]> = {};
