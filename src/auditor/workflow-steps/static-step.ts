 ...
 */
export async function executeStaticStep(
  inputs: StaticStepInputs,
  ...
  try {
    ...
    // Set outputs
    const staticOutputs: StaticStepOutputs = {
      lintResults,
      formatIssues,
      typeCheckResults,
      codeSmells
 ...
 */
async function runLintingAnalysis(inputs: StaticStepInputs): Promise<LintResult[]> {
 ...
 */
async function detectESLintConfig(workspacePath: string): Promise<boolean> {
 ...
 */
async function checkFormattingCompliance(inputs: StaticStepInputs): Promise<FormatIssue[]> {
 ...
 */
async function detectPrettierConfig(workspacePath: string): Promise<boolean> {
 ...
 */
async function performTypeChecking(inputs: StaticStepInputs): Promise<TypeCheckResult[]> {
 ...
 */
async function detectTypeScriptConfig(workspacePath: string): Promise<boolean> {
  try {
 ...
 */
async function detectCodeSmells(inputs: StaticStepInputs): Promise<CodeSmell[]> {
 ...
 * Add evidence based on static analysis results
 */
async function addStaticAnalysisEvidence(
  outputs: StaticStepOutputs,
  evidence: EvidenceItem[]
): Promise<void> {
 ...
 */
export const DEFAULT_STATIC_INPUTS: Partial<StaticStepInputs> = {
