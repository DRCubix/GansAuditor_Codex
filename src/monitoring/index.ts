...
export class MonitoringSystem {
  ...
  private auditEngine?: SynchronousAuditEngine;
  ...
  start(auditEngine?: SynchronousAuditEngine, sessionManager?: SynchronousSessionManager): void {
    ...
    try {
      ...
      this.componentLogger.error('Failed to start monitoring system', error as Error);
      throw error;
    }
  }
  ...
  async stop(): Promise<void> {
    ...
    try {
      ...
      this.componentLogger.error('Failed to stop monitoring system', error as Error);
      throw error;
    }
  }
  ...
  async exportDiagnostics(outputPath: string): Promise<void> {
    ...
    try {
      ...
      this.componentLogger.error('Failed to export diagnostics', error as Error);
      throw error;
    }
  }
   ...
   */
  async performHealthCheck(): Promise<ReturnType<typeof healthChecker.performHealthCheck>> {
   ...
   */
  async inspectSession(sessionId: string): Promise<ReturnType<typeof debugTools.inspectSession>> {
   ...
   */
  async analyzeSession(sessionId: string): Promise<ReturnType<typeof debugTools.analyzeSession>> {
   ...
   */
  async analyzePerformance(timeWindow?: number): Promise<ReturnType<typeof debugTools.analyzePerformance>> {
...
export function startMonitoring(
  ...
  auditEngine?: SynchronousAuditEngine,
  sessionManager?: SynchronousSessionManager
): void {
  if (config) {
 ...
 */
export async function getSystemStatus(): Promise<ReturnType<typeof monitoringSystem.getSystemStatus>> {
 ...
 */
export function getMonitoringSummary(): string {
 ...
 */
export function isMonitoringHealthy(): boolean {
...
export async function cleanupMonitoring(): Promise<void> {
  ...
  try {
    ...
    logger.error('Failed to cleanup monitoring system', error as Error);
    throw error;
  }
}