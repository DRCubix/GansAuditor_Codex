...
export class ValidationUtils {
  ...
  validate<T = any>(
    data: any, 
    schema: ValidationSchema | Record<string, ValidationSchema>,
    path: string = 'root'
  ): ValidationResult<T> {
    ...
    try {
      ...
      if (!('type' in schema)) {
        return this.validateObject(data, schema as Record<string, ValidationSchema>, path);
      }

      const singleSchema = schema as ValidationSchema;
  ...
  validateSessionConfig(config: any): ValidationResult<SessionConfig> {
    ...
    const result = this.validate<SessionConfig>(config, schema);
  ...
  validateGanReview(review: any): ValidationResult<GanReview> {
    ...
    return this.validate<GanReview>(review, schema);
  }
  ...
  validateAuditRequest(request: any): ValidationResult<AuditRequest> {
    ...
    return this.validate<AuditRequest>(request, schema);
  }
 ...
 */
export function configureValidationUtils(config: Partial<ValidationConfig>): void {
  (validationUtils as any).config = { ...DEFAULT_VALIDATION_CONFIG, ...config };
}
 ...
 */
export function validateSessionConfig(config: any): ValidationResult<SessionConfig> {
 ...
 */
export function validateGanReview(review: any): ValidationResult<GanReview> {
 ...
 */
export function validateAuditRequest(request: any): ValidationResult<AuditRequest> {
 ...
 */
export function validateFilePath(path: string): ValidationResult<string> {
...
export function validateData<T = any>(
  ...
  return validationUtils.validate<T>(data, schema);
}