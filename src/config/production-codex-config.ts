 ...
 */
export const DEFAULT_PRODUCTION_CODEX_CONFIG: ProductionCodexConfig = {
  executable: 'codex',
  executablePaths: [
    '/usr/local/bin/codex',
    '/usr/bin/codex',
 ...
 */
export function parseProductionCodexConfigFromEnv(): ProductionCodexConfig {
  const config = {
 ...
 */
export function validateProductionCodexConfig(config: ProductionCodexConfig): void {
 ...
 */
export function createProductionCodexConfig(overrides: Partial<ProductionCodexConfig> = {}): ProductionCodexConfig {
  const config = {
    ...DEFAULT_PRODUCTION_CODEX_CONFIG,
    ...overrides,
    // Force production-only values
    failFast: true as const,
    requireCodexAvailable: true as const,
    validateOnStartup: true as const,
    allowMockFallback: false as const,
  };
