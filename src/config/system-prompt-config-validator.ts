...
export function validateConfigurationFile(
  ...
  let configValidation: SystemPromptConfigValidation | null = null;
 ...
 */
export function validateSystemPromptConfiguration(
  configFilePath?: string,
  options: Partial<ConfigValidationOptions> = {}
